                    ...
                    <div class="card" style="border-radius: 15px;">
                        <div class="card-body p-5">
                            ...
                            <form action="<?= site_url('/store'); ?>" method="POST">
                                ...
                                <div class="form-outline mb-4">
                                    <input type="cpassword" id="cpassword" class="form-control form-control-lg" />
                                ...
                                <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="<?= site_url('/register'); ?>" class="fw-bold text-body"><u>Login here</u></a></p>
